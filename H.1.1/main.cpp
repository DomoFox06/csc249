...
int main() {
    ...
    // Course introCpp(...);
    Course introCPP("Introduction to C++", "CSC 134-0001", 3, "Prof. Johnson", true);


    // TODO 2: Create a Course object for a course YOU are currently taking
    //         Use real or made-up data - your choice!
    // Course myCourse(...);
    Course myCourse("Calculus II", "MAT 272-0001", 4, "Prof. Wilkinson", true);
    ...
    cout << "Intro C++ credits: " << introCPP.getCredits() << endl;
    cout << "Intro C++ instructor: " << introCPP.getInstructor() << endl;
    ...
    // cout << "My course is: " << ... << endl;
        ...
        cout << "My course is: " << (myCourse.getIsOnline() ? "Online" : "In-person") << endl;
    ...
    cout << "Changing to online..." << endl;
    introCPP.getIsOnline();
    cout << "Is Online: " << (introCPP.getIsOnline() ? "Yes" : "No") << endl;
    ...
    dataStructures.setCredits(10);
    cout << "After setting to 10, credits are: " << dataStructures.getCredits() << endl;
